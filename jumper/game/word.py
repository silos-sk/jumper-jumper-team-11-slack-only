...
class Word:
    """
    Secret word hidden from the player. The secret word is randomly chosen from a list of words.
    ...
    def __init__(self):
        ...
        """
        word_list = ["abruptly", "absurd", "abyss", "affix", "askew", "avenue", "awkward", "axiom",
